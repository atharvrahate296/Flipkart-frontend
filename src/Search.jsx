...
// Custom hook to extract query string from URL
function useQuery() {
...
function Search() {
  ...
  useEffect(() => {
    fetch('https://flipkart-backend-66ux.onrender.com/products')
      .then((res) => res.json())
      .then((data) => {
        let allProducts = [];

        // Check if products are nested inside documents
